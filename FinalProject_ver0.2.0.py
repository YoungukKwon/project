...
class Game:
    def __init__(self):
        ...
        self.record = self.canvas.create_text(550, 320, text=self.highest_point, font=("Helvetica", 15, "bold")) #changjin
        self.next_y = 0
...
class Figure(Sprite):
    ...
    def move(self):     # Main movement in every loop
        ...
        if self.game.point >= self.game.highest_point:
            ...
            self.game.record = self.game.canvas.create_text(550, 317, text=self.game.highest_point, font=("Helvetica", 15, "bold"))  # changjin
