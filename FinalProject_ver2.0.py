...
class Game:
    def __init__(self):
        ...
        self.record = self.canvas.create_text(550, 320, text=self.highest_point, font=("Helvetica", 15, "bold"), fill="blue") #changjin
        self.next_y = 0
    ...
    def restart(self, event): # changjin
        if self.game.running == False and self.game.canvas.coords(self.image)[1]+47 >=  self.game.canvas_height:
            ...
            if self.game.point > self.game.highest_point:
                ...
                self.game.record = self.game.canvas.create_text(550, 317, text=self.game.highest_point, font=("Helvetica", 15, "bold"), fill="blue")  # changjin
